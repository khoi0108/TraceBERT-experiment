...
class Commits:
    ...
    def add_commit(self, commit_id, summary, diff_added, diff_removed, files, commit_time):
        commit = {
            "commit_id": commit_id,
            "summary": summary,
            ...
            for commit in tqdm(local_repo.iter_commits(branch.name)):
                ...
                for line in proc.stdout:
                    ...
                    if line.startswith(("+++", "@@")):
                        ...
                        files.append(line.strip("--- a/"))
                    elif line.startswith("+"):
                        diff_added.append(line)
                    elif line.startswith("-"):
                        diff_removed.append(line)
